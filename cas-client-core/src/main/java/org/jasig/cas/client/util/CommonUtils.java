...
public final class CommonUtils {
     ...
     * @param serverName
     *            the server name to use to constuct the service url if the service
     *            param is empty
     ...
     * @return the response.
     */
    // 通过 HttpsURLConnection 调用 cas 服务器并返回结果
